...
\item
  \ressubsubheadingni{\textbf{Research Assistant}, \textit{Advised by Prof. Minlie Huang}}{CS Dept., THU}{\vspace{5pt}
    \ressubsubheading{\textbf{Domain Adaptation for Sentiment Classification}}{Sept. 2015 - Present}{
      \footnotesize
      \begin{itemize}
        \resitem{Designed a novel network structure for classifiers' adaptation of product reviews from different domains}
        ...
        \resitem{Languages: Matlab, Python, Theano}
      \end{itemize}
    }
    \ressubsubheading{\textbf{Knowledge Graph Embedding by Flexible Translation}}{\textit{Mar. 2015 - Sept. 2015}}{
      ...
      \begin{itemize}
        ...
        \resitem{Improved existing models with our principle and achieved state-of-art results, submitted to KR-16}
        \resitem{Language: C++}
      \end{itemize}
    }
    }
  \item
    \ressubsubheadingni{\textbf{Research Assistant}, \textit{Advised by Prof. Gary Chan}}{CS Dept., HKUST}{\vspace{5pt}
    \ressubsubheading{\textbf{Wi-Fi Indoor Localization by Sectors Junction}}{Sept. 2014 - Dec. 2014}{
        \footnotesize
	    \begin{itemize}
          \resitem{Implemented a novel localization algorithm by junction of Wi-Fi signal sectors}
	      \resitem{Used convex optimization to find the position, and clustering to reduce search space}
          \resitem{Gathered and cleaned the first-hand Wi-Fi data of HKUST}
